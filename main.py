...
# get from first
start = page_ajax.find('<div class="col-md-6 col-xl-4">')
end = page_ajax.find('<div class="col-md-6 col-xl-4">', start + 1)

obj = convert_html_to_obj(page_ajax[start:end])
...
# get from second
start = page_ajax.find('<div class="col-md-6 col-xl-4">', start + 1)
end = page_ajax.find('<div class="col-md-6 col-xl-4">', start + 1)
obj = convert_html_to_obj(page_ajax[start:end])

# get last
start = page_ajax.find('<div class="col-md-6 col-xl-4">', start + 1)
obj = convert_html_to_obj(page_ajax[start:])
